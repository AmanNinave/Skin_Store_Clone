...
document.querySelector("#ProductsDisplaySec > div:nth-child(1) > div:nth-child(2) > button:nth-child(1) ").addEventListener("click", careFilter1)
...
document.querySelector("#ProductsDisplaySec > div:nth-child(1) > div:nth-child(2) > button:nth-child(2) ").addEventListener("click", careFilter2)
...
document.querySelector("#ProductsDisplaySec > div:nth-child(1) > div:nth-child(2) > button:nth-child(3) ").addEventListener("click", careFilter3)
...
document.querySelector("#ProductsDisplaySec > div:nth-child(1) > div:nth-child(2) > button:nth-child(4) ").addEventListener("click", careFilter4)
...
document.querySelector("#ProductsDisplaySec > div:nth-child(1) > div:nth-child(2) > button:nth-child(6) ").addEventListener("click", careFilter6)
...
document.querySelector("#ProductsDisplaySec > div:nth-child(1) > div:nth-child(2) > button:nth-child(7) ").addEventListener("click", careFilter7)
